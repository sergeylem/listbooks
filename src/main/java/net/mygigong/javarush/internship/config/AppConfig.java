package net.mygigong.javarush.internship.config;
...
@ComponentScans(value = { @ComponentScan("net.mygigong.javarush.internship.dao"),
        @ComponentScan("net.mygigong.javarush.internship.service") })
