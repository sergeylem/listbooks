    ...
    <div class="panel panel-success">
        <div class="panel-heading" style="background-color:#786455">
            <h3 class="panel-title" style="color: #d1cbbc">
                Please, input the new book details!
            </h3>
        </div>
        <div class="panel-body">
            <form:form id="BookRegisterForm" cssClass="form-horizontal" modelAttribute="book" method="post" action="createBook">

                <div class="form-group">
                    <div class="control-label col-xs-3"> <form:label path="title" >Title</form:label> </div>
                    <div class="col-xs-6">
                        <form:hidden path="id" value="${book.id}"/>
                        <form:input cssClass="form-control" path="title" value="${book.getTitle()}"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <form:input cssClass="form-control" path="description" value="${book.getDescription()}"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <form:input cssClass="form-control" path="author" value="${book.getAuthor()}"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <form:input cssClass="form-control" path="isbn" value="${book.getIsbn()}"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <form:input cssClass="form-control" path="printYear" value="${book.getPrintYear()}"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <label class="radio-inline">
                            <input type="radio" name="readAlready" value="yes" ${book.isReadAlready() ? 'checked' : '' }"> Yes
                        </label>

                        <label class="radio-inline">
                            <input type="radio" name="readAlready" value="no" ${book.isReadAlready() ? '' : 'checked'} checked"/> No
                        </label>
